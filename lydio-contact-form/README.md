# @alexstevovich/lydio-contact-form

Contact-form component for Lydio.
...
```sh
npm install @alexstevovich/lydio-contact-form
```
...
Apache-2.0. Copyright (c) 2015 Alex Stevovich
